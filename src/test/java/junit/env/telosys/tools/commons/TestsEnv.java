...
public class TestsEnv {
	 ...
	 * @return
	 */
	public static String buildAbsolutePath(String fileName) {
	...
	public static String getTmpRootFolderFullPath() {
		return getTmpExistingFolderFullPath( "" ) ;
	}
	
	public static String getTmpBundlesFolderFullPath() {
		return getTmpExistingFolderFullPath( "/TelosysTools/templates" ) ;
	}
	
	public static String getTmpDownloadFolderFullPath() {
	 ...
	 * @return
	 */
	public static Properties loadSpecificProxyProperties()  {
	 ...
	 * @return
	 */
	public static File getTelosysToolsCfgFile()  {
	 ...
	 * @return
	 */
	public static Properties loadTelosysToolsCfgProperties()  {
